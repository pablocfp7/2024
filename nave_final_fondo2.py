...
fondo_rect1 = fondo.get_rect(topleft=(0, 0))
fondo_rect2 = fondo.get_rect(topleft=(0, -HEIGHT))  # Segunda copia del fondo
...
while running:
    ...
    fondo_rect1.y += fondo_speed
    fondo_rect2.y += fondo_speed

    # Reposicionar el fondo si sale de la pantalla
    if fondo_rect1.top >= HEIGHT:
        fondo_rect1.y = fondo_rect2.bottom - HEIGHT
    if fondo_rect2.top >= HEIGHT:
        fondo_rect2.y = fondo_rect1.bottom - HEIGHT

    # Dibujar el fondo
    screen.blit(fondo, fondo_rect1)
    screen.blit(fondo, fondo_rect2)
