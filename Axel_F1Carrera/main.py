...
pygame.display.set_caption("Carretera")
...
jugador_y = 530
velocidad_jugador = 5
jugador_imagen = pygame.image.load("auto.png")
jugador_imagen = pygame.transform.scale(jugador_imagen, (40, 70))

vidas = 5
fuera = False

auto_blanco_imagen = pygame.image.load("stop.png")
auto_blanco_imagen = pygame.transform.scale(auto_blanco_imagen, (35, 70))

auto_negro_imagen = pygame.image.load("formula-1.png")
...
while not fuera:
    ...
    if contador_obstaculos >= 30:
        ...
        tipo_obstaculo = random.choice(["stop", "formula-1"])
        if tipo_obstaculo == "stop":
