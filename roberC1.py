...
gato_normal = pygame.image.load("gatoNormal.png")

imagen_gato_actual = gato_normal
...
while corriendo:
    ...
    pantalla.blit(imagen_gato_actual, (ANCHO // 2 - gato_normal.get_width() // 2, ALTO // 1.3 - gato_normal.get_height() // 2))
