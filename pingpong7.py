...
class Pala:
    ...
    def mensajeGanador():
        ...
        font = fuente_mensaje = pygame.font.SysFont("Arial", 50)
...
class PingPong:
    ...
    def mover_paletas(self):
        ...
        if self.pala_derecha.y + self.pala_derecha.alto // 0.99 < self.pelota.y:            
            self.pala_derecha.mover("abajo")
            
        elif self.pala_derecha.y + self.pala_derecha.alto // 0.98 > self.pelota.y:
