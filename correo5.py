...
class AplicacionCorreo:
    def __init__(self, root):
        ...
        self.root.config(bg="#f0f0f0")  # Fondo gris claro
        ...
        self.imagen_boton = tk.PhotoImage(file="boton_correo4.png")  # Asegúrate de tener una imagen en el mismo directorio

        # Botón de envío con imagen
        self.boton_enviar = tk.Button(root, text="Enviar Correo", command=self.enviar_correo, bg="#4CAF50", fg="white", font=("Arial", 12, "bold"), image=self.imagen_boton, compound="left")
