...
class PingPong:
    ...
    def mover_paletas(self):
        ...
        # Movimiento de la IA (pala derecha) - la IA sigue la pelota, pero con un retraso (lentitud)
        if self.pala_derecha.rect.centery < self.pelota.rect.centery:
            # La IA se mueve hacia abajo pero con lentitud
            ...
            # La IA se mueve hacia arriba pero con lentitud
            if self.pala_derecha.rect.centery - self.pala_derecha.alto // 10 > self.pelota.rect.centery:
