...
class Pelota:
    def __init__(self):
        ...
        self.vel_max = 10  # Velocidad máxima

        # Imagen a la pelota
        self.imagen = pygame.image.load("pelota.png").convert_alpha()
        self.imagen = pygame.transform.scale(self.imagen, (self.radio * 2, self.radio * 2))
    ...
    def reiniciar(self):
        self.x = ANCHO // 2
        self.y = ALTO // 2
        self.velocidad_x = 5 * random.choice((1, -1))
        self.velocidad_y = 5 * random.choice((1, -1))
...
class Pala:
    def __init__(self, x):
        ...
        #Agregar imagen a la paleta
        self.imagen = pygame.image.load("paleta-1.png").convert_alpha()
    ...
    def dibujar(self, pantalla):
        pantalla.blit(self.imagen, (self.x, self.y, self.ancho * 2, self.alto * 2))
...
class PingPong:
    def __init__(self):
        ...
        self.pala_derecha = Pala(ANCHO - 50 - 50)
        self.pelota = Pelota()
...
def juego():
    ...
    #fondo del juego
    fondo = pygame.image.load("mesa.jpg").convert()
    ...
    while jugando:
        ...
        # Verificar si algún jugador ha ganado
        if ping_pong.puntos_izquierda >= 11:
            ping_pong.mostrar_ganador(pantalla, "¡Jugador Izquierda Gana!")
            break
        elif ping_pong.puntos_derecha >= 11:
